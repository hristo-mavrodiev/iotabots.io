...
const FAQ: React.FC = () => (
  <BaseLayout>
    <Section>
      ...
      <Container>
        <ContentBox
          image='https://assets.iotabots.io/compressed/11.png'
        ...
        <ContentBox
          image='https://assets.iotabots.io/compressed/987.png'
          // eslint-disable-next-line max-len
        ...
        <ContentBox
          image='https://assets.iotabots.io/compressed/990.png'
          // eslint-disable-next-line max-len
        ...
        <ContentBox
          image='https://assets.iotabots.io/compressed/187.png'
          // eslint-disable-next-line max-len
        ...
        <ContentBox
          image='https://assets.iotabots.io/compressed/845.png'
          // eslint-disable-next-line max-len
        ...
        <ContentBox
          image='https://assets.iotabots.io/compressed/895.png'
          // eslint-disable-next-line max-len
